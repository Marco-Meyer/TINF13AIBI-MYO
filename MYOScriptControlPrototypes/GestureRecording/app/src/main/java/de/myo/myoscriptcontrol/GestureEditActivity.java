...
//        } else if (requestCode == SHOW_PATTERN_REQUEST && resultCode == RESULT_OK){
...
//            }
            ...
            //gestenliste nicht verändern
            Toast.makeText(getApplicationContext(), "Activity mit X oder Return-Taste beendet", Toast.LENGTH_LONG).show();
        }
    }

    private void showAlertTextInput(String text){
        LayoutInflater layoutInflater = LayoutInflater.from(this);
        View promptView = layoutInflater.inflate(R.layout.activity_textinput, null);
